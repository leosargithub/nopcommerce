...
class Add_Customer_Page :
    ...
    link_customers_menuoption_xpath = "//li[@class='nav-item']//p[normalize-space(text())='Customers']"
    ...
    cusrole_guest_xpath = "//li[contains(text(),'Guest')]"
    ...
    drpdwn_mngrofvendor_id = "Vendor Id"
    text_admincommrnt_id = "AdminComment"
    ...
    def enter_password(self, password):
        self.driver.find_element(By.ID, self.text_password_id).send_key(password)
...
#
    ...
    def select_manager_of_vendor(self, value):
        drop_down = Select(self.driver.find_element(By.ID, self.drpdwn_mngrofvendor_id))
        drop_down.select_by_visible_text(value)
    def enter_admin_comments(self, admincomments):
        self.driver.find_element(By.ID, self.text_admincommrnt_id).send_keys(admincomments)
